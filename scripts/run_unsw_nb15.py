...
def main():
	...
	parser.add_argument('--dataset', default='unsw', choices=['unsw'])
	...
	logger.info('Starting run_unsw_nb15 with args: %s', vars(args))
	...
	logger.info('run_unsw_nb15 completed. Outputs: %s', run_dir)
